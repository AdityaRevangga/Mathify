      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', gap: 32, fontSize: 15, fontWeight: 500 }}>
          {['Home', 'Courses', 'Pricing', 'About Us'].map(item => (
            <a key={item} href="#" style={{ color: '#374151', textDecoration: 'none', transition: 'color 0.2s' }}
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 40, flexWrap: 'wrap', gap: 16 }}>
            <div>
              ...
              <h2 style={{ fontSize: 'clamp(22px, 3vw, 34px)', fontWeight: 800, lineHeight: 1.3, maxWidth: 400 }}>
