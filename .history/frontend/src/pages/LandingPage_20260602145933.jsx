...
const LandingPage = () => {
  ...
  const subjects = [
    { title: 'Bilangan', lessons: 11, color: '#FF6B35', image: '' },
    { title: 'Aljabar dan Fungsi', lessons: 21, color: '#1A1A2E', image: 'https://images.unsplash.com/photo-1568828668638-b1b4014d91a2?q=80&w=1495&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
