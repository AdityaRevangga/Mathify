...
const LandingPage = () => {
  ...
  const subjects = [
    { title: 'Bilangan', lessons: 11, color: '#FF6B35', image: 'https://images.unsplash.com/photo-1568828668638-b1b4014d91a2?q=80&w=1495&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
    ...
    { title: 'Geometry', lessons: 19, color: '#2D2D2D', image: 'https://images.unsplash.com/photo-1509228468518-180dd4864904?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
  ];
  ...
  const features = [
    ...
    },
    {
      ...
      title: 'Kuis Cerdas',
      desc: 'Penilaian adaptif yang menyesuaikan tingkat kesulitan berdasarkan performa Kamu untuk memastikan penguasaan materi.',
    },
    {
      icon: (
        <svg width="28" height="28" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 60, width: '100%', maxWidth: 1200, margin: '0 auto', flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: 1, minWidth: 300, animation: 'fadeUp 0.8s ease both' }}>
            ...
            <p style={{ fontSize: 16, color: '#6B7280', lineHeight: 1.7, marginBottom: 36, maxWidth: 460 }}>
              Buka potensi Kamu dengan pelajaran interaktif, latihan yang dipersonalisasi, dan dirancang untuk mengubah kecemasan terhadap matematika menjadi penguasaan matematika.
            </p>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <p style={{ color: '#6B7280', fontSize: 16, maxWidth: 520, margin: '0 auto', lineHeight: 1.7 }}>
              Kami menggabungkan pengajaran dengan teknologi mutakhir untuk menciptakan pengalaman belajar yang benar-benar efektif dan melekat.
            </p>
          </div>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 40, flexWrap: 'wrap', gap: 16 }}>
            <div>
              ...
              <h2 style={{ fontSize: 'clamp(12px, 3vw, 16px)', fontWeight: 300, lineHeight: 1.3, maxWidth: 800 }}>
